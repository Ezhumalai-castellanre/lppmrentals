        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {personData.employmentType === 'salaried' && (
            <>
              ...
              <div className="form-field">
                <Label className="mb-0.5">Length of Employment in Current Position</Label>
                <div className="grid grid-cols-2 gap-x-4">
                  <Input
                    type="number"
                    min={0}
                    value={`${personData.lengthAtCurrentPositionYears ?? ''}`}
                  ...
                  <Input
                    ...
                    min={0}
                    max={11}
                    value={`${personData.lengthAtCurrentPositionMonths ?? ''}`}
