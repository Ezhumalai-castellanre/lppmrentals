...
export function FinancialSection({ title, person, formData, updateFormData }: FinancialSectionProps) {
  ...
  // Check if this is a guarantor (guarantors cannot be students)
  const isGuarantor = person.startsWith('guarantors_') || person === 'guarantor';
  
  // Clear student employment type for guarantors
  useEffect(() => {
    if (isGuarantor && personData.employmentType === 'student') {
      handleChange('employmentType', '');
    }
  }, [isGuarantor, personData.employmentType]);
      ...
      <CardContent className="space-y-6">
        ...
        <div className="form-field">
          ...
          >
            ...
            <SelectContent>
              {/* Students option only for Co-Applicant and Applicant */}
              {!isGuarantor && <SelectItem value="student">Student</SelectItem>}
        ...
        {/* Student fields - use employment fields instead of university fields */}
